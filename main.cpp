...
void *r9_consumer(void *ptr)
{
    ...
    for (;;)
    {
        ...
        output_request_removed(Rev9, rt, consumed, sd->in_request_queue);
...
int main(int argc, char **argv)
{
    ...
    pthread_create(&tx,               NULL, &tx_consumer,     &s);
    pthread_create(&r9,               NULL, &r9_consumer,     &s);
